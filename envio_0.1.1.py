...
comprovante = ('{}{}{}{}'.format(comp1, comp2, comp3, comp4))
...
payment = random.randint(1000, 9999) # Gera automaticamente os dois ultimos digitos do Código Identificador del pago, TAG 025 e do PaymentID do JSON.
payment_1 = random.randint(0, 9)
payment_2 = random.randint(0, 9)
payment_3 = random.randint(0, 9)
payment_4 = random.randint(0, 1)
lm= chr(random.randint(ord('a'), ord('z')))
lm2= chr(random.randint(ord('a'), ord('z')))
lm3= chr(random.randint(ord('a'), ord('z')))
lM = chr(random.randint(ord('A'), ord('Z')))
lM2 = chr(random.randint(ord('A'), ord('Z')))
lM3 = chr(random.randint(ord('A'), ord('Z')))
lm4= chr(random.randint(ord('a'), ord('z')))
...
letras = ('{}{}{}{}'.format(lm, lM, lm2, lM2))
letras2 = ('{}{}{}{}'.format(lM2, lm, lm2, lM ))
numerico = ('{}{}{}{}'.format(payment_1, payment_2, payment_3, payment_4))
numerico2 = ('{}{}{}{}'.format(payment_4, payment_1, payment_3, payment_2  ))

code = ("-{}-{}-{}".format(payment, letras, numerico ))
code2 = ("-{}-{}-{}".format(letras2, numerico2, payment ))
...
four = '00400013000100000' #Tag 004 do envio de dados
...
twentyfive_T = '02500022TFISERV' #Tag 025 do envio de dados
twentyfive_E = '02500022EFISERV' #Tag 025 do envio de dados
...
py = '{}"'.format(code) # Adiciona aspas duplas no cuit digitado.
py2 = '{}"'.format(code2) # Adiciona aspas duplas no cuit digitado.
...
cnc = ':\"CANCELLED\"'
merchant = ',\"merchantId\":'
ex = ',\"Terminal\":\"AR000001\",\"Invoice\":[{\"InvoiceNumber\":{\"Type\":\"B\",\"FiscalPointSaleNumber\":\"00001\",\"Number\":\"00000'
...
#Efetivo
        if menu2  == 1:
                tag = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01047'.format(two, cuit, four, comprovante, five, data, six, hora, nine, normal, thirteen, fourteen, cash, twentyfive_E, code))
                js = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format( se, cd, dc, ct, fv, sl, merchant, ct, ex, cf, id, ef, dat, dt, ti, tm, doc, dat, dt, ti, tm, pc_E, py, sw))
                print('{}{}'.format(tag, js))

#Transação de Credito
        elif menu2 == 2:
                tg = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01058'.format(two, cuit, four, comprovante, five, data, six, hora, seven, credito, nine, normal, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour, host, twentyfive_T, code2))
                json_card = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, sl,  merchant, ct, ex, cf, id, ef, dat, dt,  ti, tm, doc_card, cbc, dat, dt, ti, tm, pc_card, py2, sw))
                print('{}{}'.format(tg, json_card))
        
#Transação de Debito
        elif menu2 == 3:
                tg = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01057'.format(two, cuit, four, comprovante, five, data, six, hora, seven, debito, nine, normal, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour, host, twentyfive_T, code))
...
#Transação de Tarjeta e Efetivo
                ...
                tg = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01275'.format(two, cuit, four, comprovante, five, data, six, hora, seven, credito, nine, normal, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour, host, twentyfive_T, code2, thirteen, fourteen, cash, twentyfive_E, code))
                json_card = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, sl,  merchant, ct, ex, cf, id, ef, dat, dt,  ti, tm, doc_T,  dat, dt, ti, tm,  pc_card, py2, doc_E, dat, dt, ti, tm, pc_E, py, sw_2))
                print('{}{}'.format(tg, json_card))
 #Factura cancelada durante una venta.
        elif menu2 == 5:
                
                #Json de cancelamento
                json_card = ('ANF00891{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, cnc, merchant, ct, ex, cf, id, ef, dat, dt, ti, tm, cancel ))
                print('{}\n'.format(json_card))
                sleep(2)
                ...
                tag = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01047'.format(two, cuit, four, comprovante, five, data, six, tiempo, nine, normal, thirteen, fourteen, cash, twentyfive_E, code))
                js = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format( se, cd, dc, ct, fv, sl, merchant, ct, ex, comp, id, ef, dat, dt, ti, tmp, doc, dat, dt, ti, tm, pc_E, py, sw))
                print('{}{}'.format(tag, js))

        elif menu2 == 6:
                comp = cf
                tag = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01047'.format(two, cuit, four, comprovante, five, data, six, hora, nine, normal, thirteen, fourteen, cash, twentyfive_E, code2))
                js = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format( se, cd, dc, ct, fv, sl, merchant, ct, ex, cf, id, ef, dat, dt, ti, tm, doc, dat, dt, ti, tm, pc_E, py2, sw))
                print('{}{}\n'.format(tag, js))
                sleep(2)
                tiempo = time.strftime('%H%M%S')
                tmp = '"{}"'.format(tiempo) # Adiciona aspas duplas no cuit digitado.
                json_card = ('ANF00891{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, cnc, merchant, ct, ex, comp, id, ef, dat, dt, ti, tmp, cancel ))
                print('{}\n'.format(json_card))
                sleep(2)
                tiempo = time.strftime('%H%M%S')
                tmp = '"{}"'.format(tiempo) # Adiciona aspas duplas no cuit digitado.
                tg = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01058'.format(two, cuit, four, comprovante, five, data, six, tiempo, seven, credito, nine, normal, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour, host, twentyfive_T, code))
...
#Menu segundario
        ...
        #Anulação de Credito
        if anul == 1:
                an = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01063'.format(two, cuit, four, comprovante, five, data, six, hora, seven, credito, nine, annulment, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour,  host, twentyfive_T, code))
                sp = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, rt, merchant, ct, ex, cf, id, nc, dat, dt, ti, tm, doc_card, cbc, dat, dt, ti, tm, pc_card, py, sw))
                print('{}{}'.format(an, sp))
        #Anulação de Debito
        elif anul == 2:
                an = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01062'.format(two, cuit, four, comprovante, five, data, six, hora, seven, debito, nine, annulment, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour, host, twentyfive_T,  code2))
                sp = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, rt, merchant, ct, ex, cf, id, nc, dat, dt, ti, tm, doc_card, cbc, dat, dt, ti, tm, pc_deb, py2, sw))
                print('{}{}'.format(an, sp))
                
        #Anulação com Efetivo        
        elif anul == 3:
                an = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01052'.format(two, cuit, four, comprovante, five, data, six, hora, nine, annulment, thirteen, fourteen, cash, twentyfive_E,  code))
                sp = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, rt, merchant, ct, ex, cf, id, nc, dat, dt, ti, tm, doc, dat, dt, ti, tm, pc_E, py, sw))
                print('{}{}'.format(an, sp))

        #Anulação de Efetivo e tarjeta.
        elif anul == 4:
                an = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01280'.format(two, cuit, four, comprovante, five, data, six, hora, seven, credito, nine, annulment, thirteen, fourteen, card, fifteen, twenty, twentyone, twentytwo, twentytree, twentyfour, host, twentyfive_T, code2, thirteen, fourteen, cash, twentyfive_E, code))
                sp = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, rt,  merchant, ct, ex, cf, id, nc, dat, dt,  ti, tm, doc_T,  dat, dt, ti, tm,  pc_card, py2, doc_E, dat, dt, ti, tm, pc_E, py, sw_2))
                print('{}{}'.format(an, sp))
        
        elif anul == 5:
                #Json de cancelamento
                json_card = ('ANF00894{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format(se, cd, dc, ct, fv, cnc, merchant, ct, ex, cf, id, nc, dat, dt, ti, tm, cancel ))
                print('{}\n'.format(json_card))
                sleep(5)
                tiempo = time.strftime('%H%M%S')
                tmp = '"{}"'.format(tiempo) # Adiciona aspas duplas no cuit digitado.
                ...
                tag = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}ANF01047'.format(two, cuit, four, comprovante, five, data, six, tiempo, nine, annulment, thirteen, fourteen, cash, twentyfive_E, code2))
                js = ('{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}'.format( se, cd, dc, ct, fv, sl, merchant, ct, ex, comp, id, ef, dat, dt, ti, tmp, doc, dat, dt, ti, tm, pc_E, py2, sw))
                print('{}{}'.format(tag, js))